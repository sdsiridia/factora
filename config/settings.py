...
https://docs.djangoproject.com/en/5.0.7/topics/settings/

For the full list of settings and their values, see
https://docs.djangoproject.com/en/5.0.7/ref/settings/
"""
...
# Database
# https://docs.djangoproject.com/en/5.0.7/ref/settings/#databases
...
# Password validation
# https://docs.djangoproject.com/en/5.0.7/ref/settings/#auth-password-validators
...
# https://docs.djangoproject.com/en/5.0.7/howto/static-files/
...
# https://docs.djangoproject.com/en/5.0.7/ref/settings/#default-auto-field
