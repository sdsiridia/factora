...
$(function () {
    ...
    select_account_payable = $('select[name="account_payable"]');
    ...
    select_account_payable.select2({
        theme: "bootstrap4",
        language: 'es',
        allowClear: true,
        ajax: {
        ...
        .on('select2:select', function (e) {
            fv.revalidateField('account_payable');
